   ...
   <div class="container">
      ...
      <ul class="pivots">
         <li>
            ...
            <ul id="home">
               <li>
                  <a href="#getstarted"><strong>Erste Schritte</strong></a>
                  <ul id="getstarted"
                     class="cardsC">
                     <br/>                            
                     <li class="fullSpan">
               ...
               <li>
                  ...
                  <ul id="user"
                     ...
                     <li>
                        <div class="container">
                           <p>App-Benutzer können selbst erstellte oder von anderen Benutzern erstellte Apps auf einem Smartphone, Tablet oder im Webbrowser <a href="/powerapps/user">suchen und ausführen</a>.</p>
                           <hr/>
                           <br/>
                        </div>
                     </li>
                              ...
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <ul>
                                       ...
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/data-platform-create-app">Automatisches Generieren einer App</a></p>
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/data-platform-create-app-scratch">Erstellen einer eigenen App</a></p>
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/open-and-run-a-sample-app">Anpassen einer Beispiel-App</a></p>
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/customize-list-form">Anpassen eines SharePoint-Formulars</a></p>
                                       ...
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/reference-properties">Referenz zu Steuerelementen</a></p>
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/formula-reference">Referenz zu Formeln</a></p>
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">Erweitern von Canvas-Apps</h3>
                                    <hr/>
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">Erweitern von modellgesteuerten Apps</h3>
                                    <hr/>
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/model-driven-apps/web-resources">Verwenden von Webressourcen</a></p>
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">Referenz</h3>
                                    <hr/>
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="https://docs.microsoft.com/en-us/dynamics365/customer-engagement/web-api/about?view=dynamics-ce-odata-9">Web-API-Referenz</a></p>
